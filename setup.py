...
PACKAGENAME = metadata.get('package_name', 'rsprocess')
DESCRIPTION = metadata.get('description', 'Package for detecting and processing sources in radio images. ')
AUTHOR = metadata.get('author', 'B. Connor McClellan')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: rsprocess requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
